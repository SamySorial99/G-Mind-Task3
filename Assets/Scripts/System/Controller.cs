...
public class Controller : MonoBehaviour
{
    ...
    private GameOriginator gameOriginator = GameOriginator.Instance;
...
public class GameOriginator
{
    ...
    private static GameOriginator instance;
    public static GameOriginator Instance
    {
        get
        {
            if (instance == null)
            {
                instance = new GameOriginator();
            }
            return instance;
        }
    }
    ...
    {
        return new GameMemento(playerPosition);
    }

    public void Restore(GameMemento memento)
    {
        playerPosition = memento.PlayerPosition;
    }
